templates.policyTemplate = function(data){
  ...
  var content = '<h2>You built a security policy!</h2><p>You are free to edit it in the textbox below, then copy and paste it into your own document. Or simply download the unedited version as text, markdown or html using the buttons.</p><textarea class="policyHolder">'+docContent+'Created '+dateStamp()+'</textarea>' + txt + md + html;
  return content;
};

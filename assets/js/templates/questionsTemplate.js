templates.questionsTemplate = function(data, params){
  ...
  pause = '<div><button title="Click to get a snapshot link for pre-selecting answers later" id="snapshotPolicy" disabled class="btn btn-tert" title="Click or press U to get a URL for returning to this process later">Get snapshot</button><div id="snapshotGroup" class="hidden"><input id="snapshotLink" type="text" readonly value="No snapshot available"><i title="Click to copy this snapshot link" id="copyBtn" class="fas fa-copy"></i></div></div>';
